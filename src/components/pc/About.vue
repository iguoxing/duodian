            ...
            <div class="landing-page">
                <header class="navbar cleared top clearfix active">
                    <div class="container containerHead">
                        ...
                        <a href="index"> <img src="https://admore-cas.oss-cn-hangzhou.aliyuncs.com/duodian/assets/img/logo.png"></a>
                    </span></div>
                ...
                <div class="about child-page">
                    <div class="main-title placeholder" style="position: relative; z-index: 0; background: none;">
                        ...
                        <div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 550px; width: 100%; z-index: -999998; position: absolute;">
                            <div class="backstretch-item" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 100%; height: 100%; z-index: -999999;">
                                <img alt="" src="https://admore-cas.oss-cn-hangzhou.aliyuncs.com/duodian/assets/img/aboutUsBack.jpg" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 100%; height: 550px; max-width: none; left: 0px; top: 0px; right: auto; bottom: auto;">
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        <h1 class="second-title">多点科技旗下产品简介</h1>
                        <p class="second-describFirst">我们为社会组织、地域社群、品牌爱好者及其他合法团体，提供基础的互联网工具以及营销平台，让其可借助互联网来进行交流与协作。我们的业务包括移动应用媒体平台、文字创作社区、移动广告营销和互联网社区业务等创新业务。</p>
                    </div>
                    <div class="container">
                        <h1 class="second-title">我们的愿景</h1>
                        <p class="second-describSecond">我们致力于构建未来的数字社群生态系统，为上亿用户提供产品和服务，且持续向世界输出价值和正能量。</p>
                    ...
                    <div class="duty container">
                        ...
                        <!-- <div class="duty container mtWords">
                            <div class="item-list clearfix">
                                ...
                                <div class="about-right">
                                    <p>ASOU 于 2013 年上线发布，是中国首款移动应用搜索（<a href="http://asou.com" target="_blank">ASO</a>）数据统计和分析产品，为全球的移动应用开发者提供应用关键词搜索数据统计服务。</p>
                                </div>
                            </div>
                        </div> -->
                        <div class="duty container mtWords">
                    ...
                    <footer class="footerCommon active">
                        <div class="container">
                            ...
                            <div class="bar-item copy-right">@2018 MoreTech Inc.</div>
                        </div>
                    </footer>
                </div>
            </div>
